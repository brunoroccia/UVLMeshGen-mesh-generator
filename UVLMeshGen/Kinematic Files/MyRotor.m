function [Theta, DTheta] = MyRotor (TimeSteps, DT, Rot0)
...
% WNominal --> Nominal angular velocity [rad / sec]

GAP          = fix ((TimeSteps+1) / 20);
WNominal_RPM = -7.44;                       % Angular velocity in RPM
WNominal     = WNominal_RPM * 2 * pi / 60;  % Convresion to raad/sec
Rot0         = Rot0 *pi /180;               % Conversion of Rot0 to radians
